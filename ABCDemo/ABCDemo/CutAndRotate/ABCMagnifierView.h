...
typedef NS_ENUM(NSInteger, ABCMagnifierStyle) {

    /** 方形放大镜 */
    ABCMagnifierStyleSquare = 0,
    /** 圆形放大镜*/
    ABCMagnifierStyleCircular,
};

NS_ASSUME_NONNULL_BEGIN

@interface ABCMagnifierView : UIWindow

/** 放大镜的宽度  - 默认90*/
@property (nonatomic, assign) float magnifierWidth;

/** 放大镜形状  -默认圆形 */
@property (nonatomic, assign) ABCMagnifierStyle magStyle;
